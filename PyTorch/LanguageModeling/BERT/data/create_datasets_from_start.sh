...
# python3 /workspace/bert/data/bertPrep.py --action text_formatting --dataset wikicorpus_zh
...
# python3 /workspace/bert/data/bertPrep.py --action sharding --dataset wikicorpus_zh
...
python3 /workspace/bert/data/bertPrep.py --action create_hdf5_files --dataset wikicorpus_zh --max_seq_length 512 \
 --max_predictions_per_seq 80 --vocab_file $BERT_PREP_WORKING_DIR/download/google_pretrained_weights/chinese_L-12_H-768_A-12/vocab.txt --do_lower_case 0
